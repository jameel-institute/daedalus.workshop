...
params:
  ...
  n_samples:
    ...
    input: numeric
  figures_out:
    label: "Figures output path."
    value: "figures"
  tables_out:
    label: "Tables output path."
    value: "tables"
---
...
figs_out <- params$figures_out
if (!dir.exists(figs_out)) {
  fs::dir_create(figs_out)
}

tables_out <- params$tables_out
...
![Distribution of R0](figures/figure.png)
...
## Economic costs due to closures and absences
